        ...
        <template v-for="(data) in formProps">
          ...
          <el-col
            ...
            <el-form-item
              ...
              :prop="hasProps(data.prop)"
              >
              <el-radio-group v-model="forms[data.prop]" :disabled="data.disabled">
                <el-radio
            ...
            <el-form-item
              ...
              <el-col
                ...
                <el-form-item :prop="hasProps(select.prop)">
                  <el-select
                    clearable
                    :filterable="select.filterable || true"
                    ...
                    <el-option
                      ...
                      :key="item.id"
                      :label="select.defaultProps ? (select.defaultProps.label ? item[select.defaultProps.label] : item.label) : item.label"
                      :value="select.defaultProps ? (select.defaultProps.id ? item[select.defaultProps.id] : item.id) : item.id">
                    </el-option>
                  </el-select>
                </el-form-item>
              </el-col>
    ...
    form: {
      handler (newVal) {
        for (let key in newVal) {
          ...
          if ((isArray(value) && isArray.length > 0) || (isString(value) && value.length > 0) || isNumber(value) || (isPlainObject(value) && Object.key(value).length > 0)) {
            console.log('sssss')
            this.forms[key] = clonedeep(value)
          }
        }
      },
      deep: true
      ...
      handler (newVal) {
        ...
        if (isPlainObject(newVal)) {
          for (let key in this.forms) {
            let value = clonedeep(this.form[key])
            if (newVal[key] == null) {
              this.$set(this.forms, key, value)
            } else {
              this.$set(this.forms, key, clonedeep(newVal[key]))
            }
          }
